...
const Navbar = () => {
  ...
  return ( 
    <div >
        ...
        <div className='lg:hidden flex justify-between  items-center h-[5vh] p-[10px] shadow-sm bg-white  '>
            <div className=' w-[30%]'>
                <img src='https://www.enforcatech.com/_nuxt/transparent2.C2Cshd8-.png' alt='logo' className=' w-[100%]' />
            </div>
            <div>
                <button onClick={()=>setShow(!show)} className='text-blue-900 font-bold justify-center items-center flex w-[20vw] h-[5vh] text-sm'>{show ?  <HiMiniXMark /> : <RxHamburgerMenu /> }</button>
            </div>
            {
            show && <div className='absolute shadow-sm bg-white top-[5vh] left-0 w-screen h-[30vh]  flex flex-col items-center gap-[30px] justify-center'>
